...
if in your config.prod.yaml or `config/packaces/prod/limenius_react.yaml` you add the following configuration, and you have V8js installed, this bundle will be much faster:
